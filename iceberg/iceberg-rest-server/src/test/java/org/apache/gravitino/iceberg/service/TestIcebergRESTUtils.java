...
public class TestIcebergRESTUtils {
  ...
  public void init() {
    ServerContext.initialize(
        new AllowAllAuthorizer(), null, IcebergConstants.ICEBERG_REST_DEFAULT_CATALOG);
  }
  ...
  void testGetGravitinoNameIdentifier() {
    ...
    Assertions.assertEquals(
        NameIdentifier.of(catalogName, "ns1", "ns2", "table"), nameIdentifier);
  }

  @Test
  void testGetCatalogName() {
    Assertions.assertEquals("catalog", PrefixResolver.getCatalogName("catalog"));
    Assertions.assertEquals(
        IcebergConstants.ICEBERG_REST_DEFAULT_CATALOG, PrefixResolver.getCatalogName(""));
    Assertions.assertEquals(
        IcebergConstants.ICEBERG_REST_DEFAULT_CATALOG, PrefixResolver.getCatalogName(null));
  }
