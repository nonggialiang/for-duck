  ...
  public void recordMetric(String catalog, Namespace namespace, MetricsReport metricsReport)
    ...
    if (metricsReport instanceof CommitReport) {
      ...
      execute(
          ...
          MAPPER.writeValueAsString(commitReport.metadata()));
      ...
      execute(
          ...
          MAPPER.writeValueAsString(scanReport.metadata()),
          MAPPER.writeValueAsString(scanReport.projectedFieldIds()),
          MAPPER.writeValueAsString(scanReport.projectedFieldNames().toString()),
