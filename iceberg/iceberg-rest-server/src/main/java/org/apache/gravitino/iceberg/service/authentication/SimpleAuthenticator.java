...
/**
 * SimpleAuthenticator provides a basic authentication mechanism: it uses the identifier provided by
 * the client (Basic auth) without any validation, and falls back to the anonymous user when no
 * credential is supplied.
 */
public class SimpleAuthenticator implements Authenticator {

  private static final Principal ANONYMOUS_PRINCIPAL = new UserPrincipal(AuthConstants.ANONYMOUS_USER);
