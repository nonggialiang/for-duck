...
/** Factory for creating {@link OAuthTokenValidator} instances based on configuration. */
public class OAuthTokenValidatorFactory {

  private OAuthTokenValidatorFactory() {}

  /** Creates and initializes a token validator based on {@link OAuthConfig#TOKEN_VALIDATOR_CLASS}. */
