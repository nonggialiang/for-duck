...
import org.apache.gravitino.iceberg.service.ListResponseFilter;
...
public class IcebergNamespaceEventDispatcher implements IcebergNamespaceOperationDispatcher {
  ...
  public CreateNamespaceResponse createNamespace(
    ...
    NameIdentifier nameIdentifier =
        IcebergRESTUtils.getGravitinoNameIdentifier(
            context.catalogName(), createRequest.namespace());
  ...
  public UpdateNamespacePropertiesResponse updateNamespace(
    ...
    NameIdentifier nameIdentifier =
        IcebergRESTUtils.getGravitinoNameIdentifier(context.catalogName(), namespace);
  ...
  public ListNamespacesResponse listNamespaces(
    ...
    NameIdentifier nameIdentifier =
        IcebergRESTUtils.getGravitinoNameIdentifier(
            context.catalogName(), parentNamespace);
    ...
    return ListResponseFilter.filterNamespaces(
        listResponse,
        context.catalogName(),
        ServerContext.getInstance().getAuthorizer());
  }
  ...
  public LoadTableResponse registerTable(
    ...
    NameIdentifier nameIdentifier =
        IcebergRESTUtils.getGravitinoNameIdentifier(
            context.catalogName(), tableIdentifier);
