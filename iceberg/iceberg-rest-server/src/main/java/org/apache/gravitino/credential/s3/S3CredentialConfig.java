 ...
 *  under the License.
 */
package org.apache.gravitino.credential.s3;
...
public class S3CredentialConfig extends Config {
  ...
  public String s3RoleArn() { return this.get(S3_ROLE_ARN); }
  public String accessKeyID() { return this.get(S3_ACCESS_KEY_ID); }
  public String secretAccessKey() { return this.get(S3_SECRET_ACCESS_KEY); }
  public String region() { return this.get(S3_REGION); }
  public String externalID() { return this.get(S3_EXTERNAL_ID); }
  public Integer tokenExpireInSecs() { return this.get(S3_TOKEN_EXPIRE_IN_SECS); }
  public String stsEndpoint() { return this.get(S3_STS_ENDPOINT); }
}
