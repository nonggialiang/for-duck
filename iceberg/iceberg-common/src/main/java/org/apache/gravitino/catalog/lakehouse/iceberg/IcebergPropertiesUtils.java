...
public class IcebergPropertiesUtils {
  ...
  static {
    ...
    map.put(IcebergConstants.GRAVITINO_JDBC_PSWD, IcebergConstants.ICEBERG_JDBC_PSWD);
    map.put(
    ...
    Map<String, String> icebergToGravitino = new HashMap<>();
    map.forEach(icebergToGravitino::put);
    ICEBERG_CATALOG_CONFIG_TO_GRAVITINO = Collections.unmodifiableMap(icebergToGravitino);
  }
