...
public class IcebergConfig extends Config implements OverwriteDefaultConfig {
  ...
  public static final ConfigEntry<String> AUTHORIZER_TYPE =
      new ConfigBuilder("authorization.authorizer")
          .doc("The authorizer implementation: 'allow-all' or 'opa'")
          .version(ConfigConstants.VERSION_1_2_0)
          .stringConf()
          .createWithDefault("allow-all");

  public static final ConfigEntry<String> OPA_URL =
      new ConfigBuilder("authorization.opa.url")
          .doc("OPA server URL, required when authorizer is 'opa'")
          .version(ConfigConstants.VERSION_1_2_0)
          .stringConf()
          .create();

  public static final ConfigEntry<Long> OPA_CACHE_TTL_SECONDS =
      new ConfigBuilder("authorization.opa.cache-ttl-seconds")
          .doc("Time-to-live (in seconds) for OPA decision cache entries")
          .version(ConfigConstants.VERSION_1_2_0)
          .longConf()
          .createWithDefault(30L);

  public static final ConfigEntry<Long> OPA_TIMEOUT_MS =
      new ConfigBuilder("authorization.opa.timeout-ms")
          .doc("Timeout (in milliseconds) for OPA HTTP requests")
          .version(ConfigConstants.VERSION_1_2_0)
          .longConf()
